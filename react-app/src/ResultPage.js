      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="form-container">
            ...
            {result.local_execution_time && (
              <>
                <pre>Local execution time: {result.local_execution_time.toFixed(4)} seconds</pre>
              </>
            )}
            {result.remote_execution_time_1 && (
              <>
                <pre>Remote 1 execution time: {result.remote_execution_time_1.toFixed(4)} seconds</pre>
              </>
            )}
            <pre>Total execution time: {result.total_execution_time.toFixed(4)} seconds</pre>
